...
Pod::Spec.new do |s|
  ...
  s.name         = "YYShyNavBar"
  s.version      = "1.0.0"
  s.summary      = "YYShyNavBar makes your UINavigationBar expand/shrink by adding just a single line. It also comes with extension view support!"
  ...
  s.homepage     = "https://github.com/yikyakjon/TLYShyNavBar"
  ...
  s.source       = { :git => "https://github.com/yikyakjon/TLYShyNavBar.git", :branch => "yikyak_1.0.1" }
